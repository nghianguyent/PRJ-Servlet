...
<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%> <%--xóa dòng import taglib--%>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <c:set var="searchValue" value="${param.txtSearchValue}"/> <%-- xóa dấu / : là 1 thẻ empty, lỗi 500 --%>
...
%>
    ...
    <%
        ...
        }//end Search value is valid and already been sent
